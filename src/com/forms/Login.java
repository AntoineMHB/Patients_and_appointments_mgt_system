...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/BrandLogo.png"))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Patient", "Doctor", "Administrator", " " }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 462, Short.MAX_VALUE)
    ...
    if (uname.equals("") || pword.equals("") || utype.equals("Select")) {
        ...
        try {
            ...
            String query = "SELECT user_name, user_type, password FROM allusers WHERE user_name=? AND user_type=? AND password=?";
            ...
            if (rs.next()) {
                ...
                if (utype.equalsIgnoreCase("Administrator") && s1.equalsIgnoreCase("administrator")) {
                    AdminPage ad = new AdminPage(un);
                    ad.setVisible(true);
                    setVisible(false);
                } else if (utype.equalsIgnoreCase("Patient") && s1.equalsIgnoreCase("patient")) {
                    PatientPage patient = new PatientPage(un);
                    patient.setVisible(true);
                    setVisible(false);
                } else if (utype.equalsIgnoreCase("Doctor") && s1.equalsIgnoreCase("doctor")) {
                    DoctorPage doctor = new DoctorPage(un);
                    doctor.setVisible(true);
                    setVisible(false);
                } else {
                    JOptionPane.showMessageDialog(rootPane, "User type not matching", "Login Error", JOptionPane.ERROR_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(rootPane, "Username or Password not matching", "Login Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (SQLException ex) {
            Logger.getLogger(Login.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(rootPane, "An error occurred while processing your request. Please try again later.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
